    ...
    with sync_playwright() as p:
        ...
        for listing in listings: 
            try:
                ...
                name_attribute = '//*[@id="QA0Szd"]/div/div/div[1]/div[3]/div/div[1]/div/div/div[2]/div[2]/div/div[1]/div[1]/h1'
                ...
                business.name = page.locator(name_attribute).inner_text() if page.locator(name_attribute).count() > 0 else ""
                print(business.name)
                ...
                if page.locator(review_count_xpath).count() > 0:
                    ...
                    business.reviews_count = 0  # Default to 0 if no reviews count is found

                # if page.locator(reviews_average_xpath).count() > 0:
                #     # business.reviews_average = float(
                #     #     # page.locator(reviews_average_xpath).inner_text().split()[0].replace(',', '').strip()
                #     #     page.locator(reviews_average_xpath).get_attribute(name_attribute).split()[0].replace(',', '.').strip()
                #     # )
                # else:
                business.reviews_average = 0.0  # Default to 0.0 if no reviews average is found
